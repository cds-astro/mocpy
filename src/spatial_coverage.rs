...
pub fn union(coverage_left: &NestedRanges<u64>, coverage_right: &NestedRanges<u64>) -> NestedRanges<u64> {
...
/// * `coverage_left` - Left operand
/// * `coverage_right` - Right operand
pub fn intersection(coverage_left: &NestedRanges<u64>, coverage_right: &NestedRanges<u64>) -> NestedRanges<u64> {
...
/// * `coverage_left` - Left operand
/// * `coverage_right` - Right operand
pub fn difference(coverage_left: &NestedRanges<u64>, coverage_right: &NestedRanges<u64>) -> NestedRanges<u64> {
...
use ndarray::{Array1, Array2, Array, Zip, Axis};
