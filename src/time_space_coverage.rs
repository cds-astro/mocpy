...
pub fn project_on_first_dim(y: &NestedRanges<u64>, coverage: &NestedRanges2D<u64, u64>) -> NestedRanges<u64> {
...
pub fn project_on_second_dim(x: &NestedRanges<u64>, coverage: &NestedRanges2D<u64, u64>) -> NestedRanges<u64> {
...
pub fn from_fits(data: Array1<i64>) -> PyResult<NestedRanges2D<u64, u64>> {
    NestedRanges2D::<u64, u64>::try_from(data)
        .map_err(|msg| {
...
pub fn union(coverage_left: &NestedRanges2D<u64, u64>, coverage_right: &NestedRanges2D<u64, u64>) -> NestedRanges2D<u64, u64> {
...
pub fn intersection(coverage_left: &NestedRanges2D<u64, u64>, coverage_right: &NestedRanges2D<u64, u64>) -> NestedRanges2D<u64, u64> {
...
pub fn difference(coverage_left: &NestedRanges2D<u64, u64>, coverage_right: &NestedRanges2D<u64, u64>) -> NestedRanges2D<u64, u64> {
